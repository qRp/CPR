...
to go
  if Comportement = 1 [
    ask turtles[ 
      if leader = nobody [ attach-turtle ] 
    ]
...
PENS
"unattached" 1.0 0 -5825686 true "" "plot count turtles [color = magenta]"
"heads" 1.0 0 -1184463 true "" "plot count turtles [color = yellow]"
"bodies" 1.0 0 -11221820 true "" "plot count turtles [color = sky]"
"tails" 1.0 0 -13840069 true "" "plot count turtles [color = lime]"
