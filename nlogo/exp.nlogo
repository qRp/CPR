...
to init 
	...
	set vision-cone 360
	set updraft-distance 3
	set too-close 1
	set max-turn 40
	set speed-change-factor 0.9

	 create-tata 20[
	set color tata_Color
	set shape tata_Shape
	setxy random-xcor random-ycor
	set speed 1
	set leader nobody
	set follower nobody
	set visible-neighbors nobody
	set closest-neighbor nobody
	set happy? false
	]

	 create-titi 20[
	set color titi_Color
	set shape titi_Shape
	setxy random-xcor random-ycor
	set speed 1
	set leader nobody
	set follower nobody
...
tata_Shape
tata_Shape
 "default" "airplane" "box" "bug" "butterfly" "car" "circle" "cow" "fish" "leaf" "line" "pentagon" "plant" "star" "target" "triangle" "truck" "turtle" "x"
1
...
tata_Color
tata_Color
 red blue white green yellow orange brown cyan pink lime turquoise sky violet magenta
1
